...
pub const mainnet_preset= BeaconPreset{
    ...
    .MIN_SLASHING_PENALTY_QUOTIENT_ALTAIR = 128,
    .PROPORTIONAL_SLASHING_MULTIPLIER_ALTAIR = 2,
    .MIN_SYNC_COMMITTEE_PARTICIPANTS = 1,
    .UPDATE_TIMEOUT = 17280,

    // BELLATRIX
    .INACTIVITY_PENALTY_QUOTIENT_BELLATRIX = 67108864,
    .MIN_SLASHING_PENALTY_QUOTIENT_BELLATRIX = 128,
    .PROPORTIONAL_SLASHING_MULTIPLIER_BELLATRIX = 2,
    .MAX_BYTES_PER_TRANSACTION = 8192,
    .MAX_TRANSACTIONS_PER_PAYLOAD = 4096,
    .BYTES_PER_LOGS_BLOOM = 256,
    .MAX_EXTRA_DATA_BYTES = 1024,
    ...
    // DENEB
    .FIELD_ELEMENTS_PER_BLOB = 32,
    .MAX_BLOB_COMMITMENTS_PER_BLOCK = 16,
    .MAX_BLOBS_PER_BLOCK = 16,
    .KZG_COMMITMENT_INCLUSION_PROOF_DEPTH = 8,

    // ELECTRA
    .MAX_DEPOSIT_REQUESTS_PER_PAYLOAD = 16,
    .MAX_WITHDRAWAL_REQUESTS_PER_PAYLOAD = 16,
    .MAX_ATTESTER_SLASHINGS_ELECTRA = 2,
    .MAX_ATTESTATIONS_ELECTRA = 128,
    .MAX_PENDING_PARTIALS_PER_WITHDRAWALS_SWEEP = 16,
    .MAX_EFFECTIVE_BALANCE_ELECTRA = 32000000000,
    .MIN_SLASHING_PENALTY_QUOTIENT_ELECTRA = 128,
    .MIN_ACTIVATION_BALANCE = 1000000000,
    .PENDING_BALANCE_DEPOSITS_LIMIT = 16,
    .PENDING_PARTIAL_WITHDRAWALS_LIMIT = 16,
    .PENDING_CONSOLIDATIONS_LIMIT = 16,
    .MAX_CONSOLIDATION_REQUESTS_PER_PAYLOAD = 16,
    .WHISTLEBLOWER_REWARD_QUOTIENT_ELECTRA = 512,
};

test "aaa" {
    try std.testing.expectEqual(mainnet_preset.MAX_BYTES_PER_TRANSACTION, 8192);
}